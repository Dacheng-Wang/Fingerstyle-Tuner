 ...
 */
class CircleGuitarTunerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_circle_guitar_tuner, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment CircleGuitarTunerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CircleGuitarTunerFragment().apply {
